 ...
 *
 * Code generation for function 'generateOFDMSignal_data'
 *
 */
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "generateOFDMSignal",                /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
emlrtRSInfo db_emlrtRSI = { 61,        /* lineNo */
  "randi",                             /* fcnName */
  "C:\\Program Files\\MATLAB\\R2017a\\toolbox\\eml\\lib\\matlab\\randfun\\randi.m"/* pathName */
};

emlrtRTEInfo emlrtRTEI = { 1,          /* lineNo */
  1,                                   /* colNo */
  "SystemCore",                        /* fName */
  "C:\\Program Files\\MATLAB\\R2017a\\toolbox\\shared\\system\\coder\\+matlab\\+system\\+coder\\SystemCore.p"/* pName */
};

/* End of code generation (generateOFDMSignal_data.c) */
